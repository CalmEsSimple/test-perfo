...
import { DivScore, TitleScore, TextTitle, Bold, DivButton, Button } from "./ScoreCss";
import { Helmet } from "react-helmet-async";
import { LandingContent } from "../ProductLanding/styled";
  ...
  useEffect(() => {
    function loadScript() {
      return new Promise((resolve, reject) => {
        ...
        script.src =
          "https://widget.reviews.io/carousel-inline-iframeless/dist.js?_t=2021072217";
    ...
    return () => {
      ...
      if (divColchones) {
        document.body.removeChild(divColchones);
      }
    };
  }, []);
  ...
  return (
    <LandingContent>
      ...
      <DivScore>
        ...
        <TextTitle>opiniones 100% verificadas.</TextTitle>
        <div id="reviewsio-carousel-widget"></div>
        <DivButton href="https://calmessimple.com.ar/opiniones-reales-de-clientes-reales/">
          <Button>¡ver más opiniones!</Button>
        </DivButton>
      </DivScore>
    </LandingContent>
  );
