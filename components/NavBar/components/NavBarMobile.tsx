    ...
    return (
        <>
            <NavBarWrapper>
                ...
                <a href={process.env.NEXT_PUBLIC_REDIRECT_URL_BASE + "/"}><MobileLogo src="https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/4cb0a97b-bb21-4f58-a83e-60eeea837e00/fit=crop" alt="logo mobile" /></a>
