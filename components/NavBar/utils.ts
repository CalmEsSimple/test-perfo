export const menuData = [
    {
        ...
        selectedProducts: [
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/02bce307-d2e0-4fe3-f976-0fff3c1c4f00/fit=crop',
                name: 'colchón original  →',
            ...
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/7b5aa4a1-2850-4ebe-c499-2e142b51a000/fit=crop',
                name: 'colchón híbrido →',
    ...
    },
    {
        ...
        selectedProducts: [
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/cf02b442-6f6d-43f4-3f99-619239616c00/fit=crop',
                name: 'base de hierro →',
                redirect: "/bases/base",
                id: "339",
            },
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/8664bdcb-11d4-4dba-fe16-d52aa5948d00/fit=crop',
                name: 'sommier calm →',
                redirect: "/bases/sommier",
                id: "1993786",
            }
    ...
    },
    {
        ...
        selectedProducts: [
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/dec473fc-90bc-4b82-a2e1-3f7762f90c00/fit=crop',
                name: 'almohada inteligente →',
                redirect: "/almohadas/almohada-inteligente",
                id: "537",
            },
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/ec8385e2-99f1-4771-408c-3877f07b3000/fit=crop',
                name: 'alta almohada →',
                redirect: "/almohadas/alta-almohada",
                id: "1855350",
            }
    ...
    },
    {
        ...
        selectedProducts: [
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/a4708d35-4df7-4a10-c3e8-3fdeb701d900/fit=crop',
                name: 'sábanas suavidad →',
                redirect: "/ropa-de-cama/sabanas-suavidad",
                id: "1835935",
            },
            {
                image_url: 'https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/c91f966d-42cb-4801-edab-b56bcd63fb00/fit=crop',
                name: 'edredón abrazo →',
                redirect: "/ropa-de-cama/edredon-abrazo",
                id: "1851772",
            }
