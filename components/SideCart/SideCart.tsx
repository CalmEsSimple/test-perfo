                        ...
                        <span className="span-coupon">
...

                            {
                                coupon.totals.total_discount !== "0" ?
                                    ...
                                    >
                                        <img src="https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/527083b1-56bb-4a75-1a98-e7cffd083800/fit=scale-down" alt="Borrar cupón" />
                                    </button> : <></>
                            }
                    ...
                    loading.loadingDeleteToCart ||
                        ...
                        <>
                            {/* <ButtonDisabled
                                ...
                                className="disabled"
                            >
                                <img src="https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/e2550a75-61c1-4ed8-97ad-deea13f59e00/fit=scale-down" alt="Icono borrar" />
                                Vaciar carrito
                            </ButtonDisabled> */}
                        ...
                        :
                        <>
                            {/* <ButtonEmptyCart onClick={() => clearCart()} aria-label="Vaciar carrito"><img src="https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/8e51ff8c-e2e3-419e-a17f-b0a7c4ecc600/fit=scale-down" alt="Icono borrar" /> Vaciar carrito</ButtonEmptyCart> */}
                ...
                <>
                    ...
                    {cartData.items_count > 0 ? (
                            ...
                            <section>
...

                                {
                                    loading.loadingUpdateToCart ?
                                        ...
                                        >
                                            <img src="https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/203e4d54-8aff-4b8c-d7b1-1af5f7148500/fit=scale-down" alt="cupon icono" />
                                        </button>
                                        :
                                        <button
                                            className="btn-cupon"
                        ...
                        <PEmptyCart>
                            ...
                            <img src="https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/fdded6b5-f37f-4eae-a0fa-522f87e77500/fit=scale-down" alt="Carrito img" />
                        </PEmptyCart>
                    }
