...
import EntregaDeEnsuenoLanding from '@/components/EntregaDeEnsuenoLanding/EntregaDeEnsuenoLanding'
...
export const getStaticProps: GetStaticProps<ILanding> = async () => {
  const landingSEO = await getLandingSEO('cllzhlbc49ish0aiw5x4sstmi')
